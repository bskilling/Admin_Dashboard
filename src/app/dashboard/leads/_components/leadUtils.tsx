...
import { Building2, UserSquare, Briefcase, GraduationCap, LandmarkIcon } from 'lucide-react';
...
export const filterLeads = (leads: Lead[], filters: FilterOptions, activeTab: string): Lead[] => {
  return leads.filter(lead => {
    ...
    // const matchesCategory = !filters.category || lead.course?.category?._id === filters.category;
    const matchesCourse = !filters.courseId || lead.course?._id === filters.courseId;
    ...
    const matchesSearch =
      ...
      (lead.course?.title &&
        lead.course.title.toLowerCase().includes(filters.searchQuery.toLowerCase()));
