const data = [
  {
    ...
    description:
      "This course delves deep into advanced techniques for analyzing complex datasets.",
    ...
    training_metadata: {
      ...
      key_features: [
        ...
        { title: "Case studies from industry" },
      ],
      benefits: [
      ...
      certification_image:
        "https://example.com/certification_image_advanced.jpg",
      FAQs: [
        {
  ...
  },
  {
    ...
    description:
      "This course introduces the basics of Python programming language.",
  ...
  },
  {
    ...
    training_metadata: {
      ...
      certification_text: "Certificate of completion",
      certification_image:
        "https://example.com/neural_networks_certificate.jpg",
      FAQs: [
        {
          question: "Is this course suitable for beginners?",
          answer:
            "Yes, beginners with basic Python knowledge can take this course.",
        },
      ],
      curriculum: [
        {
  ...
  },
  {
    ...
    training_metadata: {
      ...
      overview:
        "Master the basics of web development and build your own projects.",
  ...
  },
  {
    ...
    training_metadata: {
      ...
      overview:
        "Master the art of presenting data visually for better understanding.",
  ...
  },
  {
    ...
    training_metadata: {
      ...
      overview:
        "Dive deep into the field of natural language processing and text analysis.",
      ...
      FAQs: [
        {
          question: "Is this course suitable for beginners?",
          answer:
            "No, this course requires prior knowledge of Python and machine learning.",
        },
      ],
      curriculum: [
        {
